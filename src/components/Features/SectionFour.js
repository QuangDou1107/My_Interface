        ...
        <div className="px-14 pt-6 pb-12 bg-[#F4F5F8]">
            <div className="bg-white  rounded-[12px]">
                <div className="p-4">
                    {/* Phần tiêu đề */}
                    <div className="flex">
                        <p className="text-xl font-bold text-black mt-2 ml-9">iPhone. </p>
                        <p className="text-xl font-bold text-gray-400 pl-2 mt-2 ">Mọi phiên bản - Hãy chọn mẫu bạn thích</p>
                    </div>
